...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-surface-paper data-[state=open]:bg-surface-paper',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-popover min-w-[8rem] overflow-hidden bg-white border border-line p-1 shadow-md',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-xs font-bold uppercase tracking-widest text-text-secondary',
      inset && 'pl-8',
      className
    )}
    {...props}
