...
interface PestelPesPageProps {
    data: PESTELAnalysis;
    companyName: string;
    date: string;
}

export function PestelPesPage({ data, companyName, date }: PestelPesPageProps) {
    return (
        <div className="w-[842px] h-[595px] max-w-[842px] max-h-[595px] overflow-hidden p-8 flex flex-col bg-white">
            <div className="flex justify-between mb-4 pb-2 border-b border-[#E5E0D6]">
                <div className="text-[10px] font-semibold text-[#B89E68]">05</div>
