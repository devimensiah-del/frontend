      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="json">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-500 mb-4">Use este editor para visualizar ou editar todos os frameworks. Para outros frameworks além de SWOT, PESTEL, Porter e Síntese, use este editor JSON.</p>
