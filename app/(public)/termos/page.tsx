    ...
    <Container className="py-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <Heading as="h2">1. Aceitação dos Termos</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">2. Descrição dos Serviços</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">3. Uso dos Serviços</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">4. Propriedade Intelectual</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">5. Confidencialidade</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">6. Limitação de Responsabilidade</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">7. Pagamento e Reembolso</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">8. Prazo de Entrega</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">9. Rescisão</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">10. Modificações dos Termos</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">11. Lei Aplicável</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading as="h2">12. Contato</Heading>
          <Text>
