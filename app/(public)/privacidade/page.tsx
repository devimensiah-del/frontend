    ...
    <Container className="py-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <Heading level={2}>1. Informações que Coletamos</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>2. Como Usamos Suas Informações</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>3. Compartilhamento de Dados</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>4. Segurança</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>5. Seus Direitos</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>6. Cookies e Tecnologias Similares</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>7. Retenção de Dados</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>8. Alterações a Esta Política</Heading>
          <Text>
        ...
        <section className="space-y-4">
          <Heading level={2}>9. Contato</Heading>
          <Text>
