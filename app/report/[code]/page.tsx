...
export default function PublicReportPage() {
  ...
  const {
    ...
    queryKey: ["public-report", code, isAdminPreview],
    queryFn: () => publicApi.getReportByAccessCode(code, isAdminPreview),
    retry: false,
  });
  ...
  const rawAnalysis: any = report.analysis || {};
  ...
  // Blur status - default to true (blurred) if not specified
  // Admin preview always shows unblurred content
  const isBlurred = isAdminPreviewMode ? false : (report?.is_blurred ?? true);
        ...
        <div className="relative flex-1 flex flex-col justify-center px-6 lg:px-24 pt-24">
          <div className="max-w-5xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-medium text-white mb-6 tracking-tight leading-tight">
              Inteligência<br />
              <span className="text-gold-500 italic font-serif">Estratégica</span>
            </h1>
            <p className="text-lg lg:text-xl text-gray-300 max-w-2xl mb-12 leading-relaxed font-light">
              Este relatório foi gerado pela plataforma IMENSIAH, combinando
              Inteligência Artificial com expertise humana para entregar
              insights estratégicos de alto impacto.
            </p>
      ...
      <section className="bg-navy-900 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Button asChild className="bg-gold-500 hover:bg-gold-600 text-navy-900 px-10 py-5 text-xs uppercase tracking-widest font-bold">
            <a href="/#diagnostico" className="inline-flex items-center gap-3">
              Solicitar Análise
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-8 text-sm text-gray-500">
            <a href="/termos" className="hover:text-navy-900 transition-colors">Termos de Uso</a>
            <a href="/privacidade" className="hover:text-navy-900 transition-colors">Privacidade</a>
          </div>
        </div>
      </div>
    </footer>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className={cn(
          ...
          <p className={cn(
            ...
            Entre em contato para desbloquear todo o potencial do relatório.
          </p>
          <Button
            asChild
...
function SWOTSection({ swot, sectionNumber }: { swot: any; sectionNumber: string }) {
  ...
  // Helper to normalize SWOT items (can be strings or objects with content/confidence)
...
function TamSamSomSection({ tamSamSom, sectionNumber }: { tamSamSom: any; sectionNumber: string }) {
  ...
  const proxyIndicators = normalizeToArray(tamSamSom.proxy_indicators || tamSamSom.proxyIndicators);
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-6 lg:px-24 py-24">
      <div className="max-w-6xl mx-auto w-full">
        ...
        {/* Next Steps (if data quality is not complete) */}
        {nextSteps.length > 0 && (
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-6 lg:px-24 py-24 bg-gray-50">
      <div className="max-w-6xl mx-auto w-full">
        ...
        {/* Performance Gaps & Best Practices */}
    ...
    <div className="min-h-screen flex flex-col justify-center px-6 lg:px-24 py-24">
      <div className="max-w-6xl mx-auto w-full">
        <div className="mb-12">
          ...
          {summary && (
            <p className="text-lg text-gray-600 max-w-3xl">{summary}</p>
          )}
        </div>
        {children}
      </div>
...
function normalizeAnalysis(raw: any) {
  // Normalize benchmarking to handle snake_case from backend
