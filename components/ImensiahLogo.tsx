...
interface LogoProps {
  ...
  variant?: 'default' | 'white'; // Color variant for different backgrounds
}

export const ImensiahLogo = ({
  className = "w-full h-full",
  showText = true,
  variant = 'default'
}: LogoProps) => {
  // Color scheme based on variant
  const leftColor = variant === 'white' ? 'white' : 'var(--navy-900)';
  const rightColor = variant === 'white' ? 'white' : 'var(--gold-500)';
  ...
  return (
    ...
    >
      ...
      <g id="LeftBrain_A" stroke={leftColor} strokeWidth="8" strokeLinecap="round" strokeLinejoin="round">
        {/* The "A" Shape */}
        ...
        <circle cx="15" cy="60" r="5" fill={leftColor} stroke="none" />

        <path d="M20 100 H50" /> {/* Middle Input */}
        <circle cx="15" cy="100" r="5" fill={leftColor} stroke="none" />

        <path d="M30 140 H50 L60 120" /> {/* Bottom Input */}
        <circle cx="25" cy="140" r="5" fill={leftColor} stroke="none" />
      ...
      <g id="RightBrain_H" stroke={rightColor} strokeWidth="8" strokeLinecap="round" strokeLinejoin="round">
        {/* The "H" Shape */}
        ...
        <circle cx="225" cy="50" r="5" fill={rightColor} stroke="none" />

        <path d="M170 100 C190 100 200 110 220 100" /> {/* Middle Synapse */}
        <circle cx="225" cy="100" r="5" fill={rightColor} stroke="none" />

        <path d="M150 140 C160 150 190 130 200 150" /> {/* Bottom Synapse */}
        <circle cx="205" cy="150" r="5" fill={rightColor} stroke="none" />
